...
export function DashboardView({ theme, onThemeToggle, onNavigateToSettings, onManageMembersClick, onMobileMenuClick, stats }: DashboardViewProps) {
      ...
      <header className={cn(
        ...
        {onMobileMenuClick && (
          <button
            ...
            className={cn(
              "md:hidden h-9 w-9 rounded-lg transition-colors flex items-center justify-center mr-2",
              isDark
        ...
        <Tabs defaultValue="overview" className="h-full flex flex-col">
          ...
          <div className="px-3 md:px-6 pt-4 md:pt-6 pb-3 md:pb-4 mb-2 md:mb-4">
            <TabsList className={cn(
              ...
              <TabsTrigger value="leads" className="gap-1.5 md:gap-2 px-3 md:px-4 py-2 text-xs md:text-sm dark:data-[state=active]:border-transparent whitespace-nowrap">
                <Users className="w-3.5 h-3.5 md:w-4 md:h-4" />
                Leads
              </TabsTrigger>
              <TabsTrigger value="conversations" className="gap-1.5 md:gap-2 px-3 md:px-4 py-2 text-xs md:text-sm dark:data-[state=active]:border-transparent whitespace-nowrap">
                <MessageSquare className="w-3.5 h-3.5 md:w-4 md:h-4" />
                Conversas
              </TabsTrigger>
              <TabsTrigger value="campaigns" className="gap-1.5 md:gap-2 px-3 md:px-4 py-2 text-xs md:text-sm dark:data-[state=active]:border-transparent whitespace-nowrap">
                <Megaphone className="w-3.5 h-3.5 md:w-4 md:h-4" />
                Campanhas
              </TabsTrigger>
              <TabsTrigger value="ai" className="gap-1.5 md:gap-2 px-3 md:px-4 py-2 text-xs md:text-sm dark:data-[state=active]:border-transparent whitespace-nowrap">
