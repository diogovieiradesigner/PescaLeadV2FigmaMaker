-- Migration: AI Get Schema
-- Adds function for AI to dynamically fetch table schema information
-- This allows the AI to understand the structure of tables before querying

-- ============================================
-- 1. FUNCTION: ai_get_schema
-- Returns schema information for allowed tables
-- ============================================
