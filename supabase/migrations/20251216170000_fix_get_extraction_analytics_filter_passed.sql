-- =============================================================================
-- CORREÇÃO: get_extraction_analytics - Calcular baseado nos leads CRIADOS
-- =============================================================================
-- O problema: estava calculando score de 126 leads qualificados, mas apenas 53
-- foram criados. Agora usamos CTE com LIMIT para pegar apenas os leads criados.
--
-- IMPORTANTE:
-- - filter_passed = true: Leads que passaram nos filtros de qualidade (pode ser > created_quantity)
-- - created_quantity: Quantidade real de leads migrados para a tabela final
-- - As estatísticas de contato e score são baseadas nos LEADS CRIADOS (created_quantity)
-- =============================================================================
...
BEGIN
  ...
  -- ========================================
  -- CONTADORES DE CONTATO (APENAS LEADS CRIADOS - usando CTE com LIMIT)
  -- ========================================
